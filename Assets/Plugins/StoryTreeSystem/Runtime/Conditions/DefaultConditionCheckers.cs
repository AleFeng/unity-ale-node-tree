namespace StoryTreeSystem
{
    ...
    /// </summary>
    public class NodeUnlockedChecker : IStoryConditionChecker
    {
        ...
        {
            bool isUnlocked = StorySaveDataManager.Instance.IsNodeUnlocked(conditionParam);
            switch (comparison)
            {
    ...
    /// </summary>
    public class NodeFinishedChecker : IStoryConditionChecker
    {
        ...
        public bool Check(string conditionParam, EConditionComparison comparison, object context)
        {
            bool isFinished = StorySaveDataManager.Instance.IsNodeFinished(conditionParam);
            switch (comparison)
            {
                case EConditionComparison.Equal:
                case EConditionComparison.Greater:
