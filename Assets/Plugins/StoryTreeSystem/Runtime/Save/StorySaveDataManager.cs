...
namespace StoryTreeSystem
{
    ...
    /// </summary>
    public class StorySaveDataManager
    {
        private static StorySaveDataManager _instance; // 单例实例
        /// <summary>获取全局单例，首次访问时自动创建。</summary>
        public static StorySaveDataManager Instance => _instance ??= new StorySaveDataManager();
