...
namespace StoryTreeSystem
{
    ...
    public class StoryNodeData
    {
        ...
        public List<StoryNodeCustomData> customDataList = new List<StoryNodeCustomData>();
        ...
        public void SetCustomData(string key, string value)
        {
            ...
            customDataList.Add(new StoryNodeCustomData { key = key, value = value });
        }
        #endregion
        ...
        private static bool EvaluateGroup(ConditionGroupData group, object context)
        {
            ...
            if (group.satisfyType == EConditionSatisfyType.All)
            {
                ...
                {
                    if (c == null) continue;
                    if (!StoryConditionManager.Instance.Check(c.conditionType, c.conditionParam, c.comparison, context))
                        return false;
                }
                return true;
            }
        ...
        public bool IsFinish() => StorySaveDataManager.Instance.IsNodeFinished(nodeId);
        #endregion
    }
}
